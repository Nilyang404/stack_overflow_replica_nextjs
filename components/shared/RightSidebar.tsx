...
const RightSidebar = () => {
  ...
  return (
    ...
    light-border custom-scrollbar sticky right-0 top-0 flex h-screen w-[350px] flex-col overflow-y-auto border-l 
    ...
    >
      ...
      <div className="mt-16">
        <h3 className="h3-bold text-dark200_light900">Popular Tas</h3>
